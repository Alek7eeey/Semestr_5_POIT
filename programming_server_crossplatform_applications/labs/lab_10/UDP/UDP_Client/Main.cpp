...
int main()
{
	...
	try
	{
		...
		if (sendto(cC, newMessage, strlen(newMessage) + 1, NULL, (sockaddr*)&serv, sizeof(serv)) == SOCKET_ERROR)
		{
			throw  SetErrorMsgText("sendto:", WSAGetLastError());
		}
		servlenght = sizeof(serv);
		if ((recvfrom(cC, newMessage, sizeof(newMessage), NULL, (sockaddr*)&serv, &servlenght)) == SOCKET_ERROR)
		{
