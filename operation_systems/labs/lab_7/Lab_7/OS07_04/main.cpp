...
int main() {
	...
	if (!SetWaitableTimer(htimer, (LARGE_INTEGER*)&it, 6000, NULL, NULL, FALSE))

		throw "SetWaitableTimer Error";

	LPCWSTR path = L"D:\\studing\\5_semestr\\operation_systems\\labs\\lab_7\\Lab_7\\Debug\\OS07_04x.exe";
