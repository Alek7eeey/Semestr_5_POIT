...
int main(int argc, char* argv[])
{
	try
	{
		if (argc == 4)
		{
			...
			LPCWSTR path1 = L"D:\\studing\\5_semestr\\operation_systems\\labs\\lab_5\\Lab_5\\Debug\\OS05_02x.exe";
			LPCWSTR path2 = L"D:\\studing\\5_semestr\\operation_systems\\labs\\lab_5\\Lab_5\\Debug\\OS05_02x.exe";
